...
function passwordStrength(pw) {
  ...
  const score = (pw.length >= 6 ? 1 : 0) + (pw.length >= 10 ? 1 : 0) + (hasSpecial ? 1 : 0) + (hasUpper ? 1 : 0) + (hasDigit ? 1 : 0);
...
function ForgotPasswordView({
  ...
  }, "We'll send a reset link to your email."), sent && /*#__PURE__*/React.createElement("div", {
    className: "auth-success"
  }, "Reset link sent! Check your email \u2705"), error && /*#__PURE__*/React.createElement("div", {
  ...
  }, loading ? /*#__PURE__*/React.createElement(Spinner, null) : sent ? 'Email Sent ✓' : 'Send Reset Link'));
}
...
function PhoneSignInView({
  ...
  }, "\uD83D\uDCF1 Phone Sign In"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '.82rem',
      color: '#9097b8',
      marginBottom: 18
    }
  }, "We'll send a one-time password to your phone."), error && /*#__PURE__*/React.createElement("div", {
    className: "auth-error"
  }, error), !otpSent ?
  /*#__PURE__*/
  ...
  React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("label", {
    ...
    disabled: loading
  }, loading ? /*#__PURE__*/React.createElement(Spinner, null) : 'Send OTP 📲')) :
  /*#__PURE__*/
  /* ── Step 2: OTP entry ── */
  ...
  }, "OTP sent to ", countryCode, phone, " \u2705"), /*#__PURE__*/React.createElement("label", {
    className: "auth-label",
    style: {
      textAlign: 'center',
      display: 'block'
    }
  }, "Enter 6-digit OTP"), /*#__PURE__*/React.createElement("div", {
    className: "otp-grid"
  }, otp.map((digit, i) => /*#__PURE__*/React.createElement("input", {
    key: i,
    ref: otpRefs[i],
    className: "otp-box",
    type: "text",
  ...
  }, verifying ? /*#__PURE__*/React.createElement(Spinner, null) : 'Verify OTP ✓'), /*#__PURE__*/React.createElement("button", {
  ...
  }, loading ? /*#__PURE__*/React.createElement(Spinner, null) : resendTimer > 0 ? `Resend OTP in ${resendTimer}s` : 'Resend OTP')), /*#__PURE__*/React.createElement("div", {
...
function MobileSignInView({
  ...
  async function handleMobileLogin(e) {
    ...
    try {
      ...
      const snap = await window.db.collection('users_mobile').where('mobile', '==', digits).limit(1).get();
      if (snap.empty) {
  ...
  }, showPass ? '🙈' : '👁️')), /*#__PURE__*/React.createElement("button", {
    className: "auth-btn",
    type: "submit",
    disabled: loading
  }, loading ? /*#__PURE__*/React.createElement(Spinner, null) : '📱 Sign In with Mobile'), /*#__PURE__*/React.createElement("div", {
...
function MobileSignUpView({
  ...
  async function handleMobileSignUp(e) {
    ...
    try {
      ...
      const ref = await window.db.collection('users_mobile').add({
        ...
        mobile: digits,
        password,
        // NOTE: plain-text per project requirement
        type: 'mobile_user',
        // collection type tag
        loginMethod: 'mobile',
  ...
  return /*#__PURE__*/React.createElement("form", {
    ...
    className: "auth-input-icon",
    onClick: () => setShowPass(s => !s)
  }, showPass ? '🙈' : '👁️')), strength && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: -8,
      marginBottom: 14
    }
  ...
  }, strengthLabel[strength], " password")), /*#__PURE__*/React.createElement("label", {
    className: "auth-label"
  ...
  }, showConfirm ? '🙈' : '👁️')), /*#__PURE__*/React.createElement("button", {
    className: "auth-btn",
    type: "submit",
    disabled: loading
  }, loading ? /*#__PURE__*/React.createElement(Spinner, null) : '📱 Create Mobile Account'), /*#__PURE__*/React.createElement("div", {
    className: "auth-divider",
    style: {
      marginTop: 16
    }
...
function SignInView() {
  ...
  if (showForgot) {
    return /*#__PURE__*/React.createElement(ForgotPasswordView, {
  ...
  if (loginMethod === 'phone') {
    return /*#__PURE__*/React.createElement(MobileSignInView, {
  ...
  return /*#__PURE__*/React.createElement("form", {
    ...
    "aria-label": "Toggle password",
    onClick: () => setShowPass(s => !s)
  }, showPass ? '🙈' : '👁️')), /*#__PURE__*/React.createElement("div", {
    className: "auth-row"
  }, /*#__PURE__*/React.createElement("label", {
    ...
    type: "submit",
    disabled: loading
  }, loading ? /*#__PURE__*/React.createElement(Spinner, null) : '🔑 Sign In to RAYMAX'), /*#__PURE__*/React.createElement("div", {
    className: "auth-divider",
    style: {
      marginTop: 16
    }
...
function SignUpView() {
  ...
  /* ─── Render ─── */
  return /*#__PURE__*/React.createElement("div", null, (signupMethod === 'mobile' || step === 1) && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
  ...
  }, [['email', '📧 Email'], ['mobile', '📱 Mobile']].map(([m, label]) => /*#__PURE__*/React.createElement("button", {
    key: m,
    type: "button",
    onClick: () => {
      setSignupMethod(m);
  ...
  }, label))), signupMethod === 'mobile' && /*#__PURE__*/React.createElement(MobileSignUpView, {
    onSwitchToEmail: () => setSignupMethod('email')
  }), signupMethod === 'email' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(StepDots, {
    step: step,
    total: 3
    ...
    type: "submit",
    disabled: loading
  }, loading ? /*#__PURE__*/React.createElement(Spinner, null) : 'Continue →')), step === 2 && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center'
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "We sent a verification link to:"), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "Open your email and click the verification link to continue."), verifyErr && /*#__PURE__*/React.createElement("div", {
    className: "auth-error"
  }, verifyErr), /*#__PURE__*/React.createElement("button", {
    id: "check-verified-btn",
    className: "auth-btn",
    onClick: handleCheckVerified,
    disabled: checking
  }, checking ? /*#__PURE__*/React.createElement(Spinner, null) : "I've verified my email ✓"), /*#__PURE__*/React.createElement("button", {
    className: "auth-btn-sec",
    onClick: handleResend,
  ...
  }, resendTimer > 0 ? `Resend in ${resendTimer}s` : 'Resend Email'), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '.72rem',
      color: '#9097b8',
      marginTop: 14
    }
  }, "\uD83D\uDCC2 Check spam folder if not received")), step === 3 && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center'
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Welcome to RAYMAX!"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '.88rem',
      color: '#9097b8',
      marginBottom: 24
    }
  }, "Your account is ready. Start tracking solar energy."), /*#__PURE__*/React.createElement("button", {
...
function App() {
  ...
  }, "\uD83D\uDE80 Sign Up")), activeTab === 'signin' ? /*#__PURE__*/React.createElement(SignInView, null) : /*#__PURE__*/React.createElement(SignUpView, null), /*#__PURE__*/React.createElement("div", {
